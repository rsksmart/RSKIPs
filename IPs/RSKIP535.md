...
This RSKIP does not specify how the content of `baseEvent` is selected by the miners, not how the content is verified by the consensus code (these rules will be specified in a separate RSKIP).
