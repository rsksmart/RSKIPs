...
- *bytes32* **derivationArgumentsHash**: A Keccak hash of the external derivation arguments (EDAs).
...
The utility function **getStorageKeyForDerivationArgumentsHash**(btcTxHash, UPI) computes an unique storage cell address as the keccack256 hash of the following string:
...
The utility function **getStorageKeyForfastBridgeFederationInformation**(redeemScriptHash) computes an unique storage cell address as the keccack256 hash of the following string:
